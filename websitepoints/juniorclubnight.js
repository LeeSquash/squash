// ========================================
// JUNIOR CLUBNIGHT POINT CALCULATOR
// ========================================

import { POINTS_CONFIGURATION } from "./configuration.js";

export function calculateJuniorClubnightPoints(records) {

    let totalPoints = 0;

    if (!records || records.length === 0) return 0;

    const rules = POINTS_CONFIGURATION.competitions.juniorclubnight.rules;
    const bonuses = POINTS_CONFIGURATION.competitions.juniorclubnight.seasonFinish;
